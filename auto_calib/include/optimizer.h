...
public:
    ...
    // Optimizer();
    Optimizer(const Mat *imgf,const Mat *imgl,const Mat *imgb,const Mat *imgr,int camera_model_index,int rows,int cols);
    ~Optimizer();   
    void initializeK();
    void initializeD();
    void initializePose();    
    ...
    void fine_random_search_params(int search_count, 
                                    ...
                                    double t0_ep0,double t0_ep1,double t1_ep0,double t1_ep1,double t2_ep0,double t2_ep1,
                                    string idx,string model);
    // double extract_commonview_and_compute_loss(Mat img1,Mat img2,string idx,string model);
    ...
    double back_camera_and_compute_loss(Mat img1,Mat img2,Eigen::Matrix4d T,string idx,string model,double height);
