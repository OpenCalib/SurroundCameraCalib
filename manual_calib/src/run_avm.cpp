...
cv::Mat project_on_ground(cv::Mat img, Eigen::Matrix4d T_CG,
						  ...
						  cv::Mat K_G,int rows, int cols, int camera_model,float height){
...
void saveResult(const int &frame_id) {
  ...
  fCalib << "R:\n"
         << calibration_matrix_[frame_id](0, 0) << " " << calibration_matrix_[frame_id](0, 1) << " "
         << calibration_matrix_[frame_id](0, 2) << "\n"
         << calibration_matrix_[frame_id](1, 0) << " " << calibration_matrix_[frame_id](1, 1) << " "
         << calibration_matrix_[frame_id](1, 2) << "\n"
         << calibration_matrix_[frame_id](2, 0) << " " << calibration_matrix_[frame_id](2, 1) << " "
         << calibration_matrix_[frame_id](2, 2) << std::endl;
  fCalib << "t: " << calibration_matrix_[frame_id](0, 3) << " "
         << calibration_matrix_[frame_id](1, 3) << " " << calibration_matrix_[frame_id](2, 3)
         << std::endl;

  fCalib << "************* json format *************" << std::endl;
  fCalib << "Extrinsic:" << std::endl;
  fCalib << "[" << calibration_matrix_[frame_id](0, 0) << "," << calibration_matrix_[frame_id](0, 1)
         << "," << calibration_matrix_[frame_id](0, 2) << "," << calibration_matrix_[frame_id](0, 3)
         << "],"
         << "[" << calibration_matrix_[frame_id](1, 0) << "," << calibration_matrix_[frame_id](1, 1)
         << "," << calibration_matrix_[frame_id](1, 2) << "," << calibration_matrix_[frame_id](1, 3)
         << "],"
         << "[" << calibration_matrix_[frame_id](2, 0) << "," << calibration_matrix_[frame_id](2, 1)
         << "," << calibration_matrix_[frame_id](2, 2) << "," << calibration_matrix_[frame_id](2, 3)
         << "],"
         << "[" << calibration_matrix_[frame_id](3, 0) << "," << calibration_matrix_[frame_id](3, 1)
         << "," << calibration_matrix_[frame_id](3, 2) << "," << calibration_matrix_[frame_id](3, 3)
         << "]" << std::endl;
...
int main(int argc, char **argv) {
  if (argc != 5) {
    cout << "Usage: ./run_avm <image_path> "
            "<intrinsic_path> <extrinsic_path>" "<camera_model>"
            "0 represents fisheye model in opencv,1 represents Omnidirectional model and 2 represents pinhole model"
            "\nexample:\n\t"
  ...
  while (!pangolin::ShouldQuit()) {
    ...
    if(frameStep.GuiChanged()){
      ...
      CalibrationScaleChange(cali_frame);
      imgs_G[cali_frame] = project_on_ground(imgs[cali_frame],calibration_matrix_[cali_frame],K[cali_frame],
                                             dist[cali_frame],K_G,rows,cols,camera_model,bev2ground[cali_frame]);
    }
