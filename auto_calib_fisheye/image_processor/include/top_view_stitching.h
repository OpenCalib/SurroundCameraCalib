 ...
 */
#ifndef PARKING_PERCEPTION_IMAGE_PROCESSOR_TOP_VIEW_STITCHING_H_
#define PARKING_PERCEPTION_IMAGE_PROCESSOR_TOP_VIEW_STITCHING_H_
...
class TopViewStitching
{
public:
    TopViewStitching();

    TopViewStitching(const std::string& fragShader, const std::string& vertShader,
...
private:
    ...
    std::string fragShader_ = "./data/calib/BowlFragShader_16_18.fsh";
    std::string vertShader_ = "./data/calib/BowlVertShader_16_18.vsh";
...
#endif  // PARKING_PERCEPTION_IMAGE_PROCESSOR_TOP_VIEW_STITCHING_H_