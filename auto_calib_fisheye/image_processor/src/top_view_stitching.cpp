...
TopViewStitching::TopViewStitching()
{
...
TopViewStitching::TopViewStitching(const std::string& fragShader, const std::string& vertShader,
                                   const std::string& modelName, const std::string& textureTVImage0,
                                   const std::string& textureTVImage1,
                                   const std::string& textureTVImage2,
                                   const std::string& textureTVImage3,
                                   const std::string& calibInfo0, const std::string& calibInfo1,
                                   const std::string& calibInfo2, const std::string& calibInfo3)
...
void TopViewStitching::loadResource()
{
    loadUVsList();
    loadBlendingData();
}

void TopViewStitching::loadBlendingData()
{
    for (int i = 0; i < MAX_SHAPE; i++)
    {
...
bool TopViewStitching::init(int width, int height)
{
    width_  = width;
    height_ = height;
...
void TopViewStitching::loadUVsList()
{
    // Init data for bowl
    vertices_.clear();
...
void TopViewStitching::deinit()
{
    deleteTextures();
    deleteVBOs();
}

void TopViewStitching::draw(int camPos)
{
...
bool TopViewStitching::render(int camPos)
{
    if (!isInitSuccess_)
    {
        return false;
...
bool TopViewStitching::setTexture(GLuint tex, int camPos)
{
...
bool TopViewStitching::createBlendingTextures(int camPos)
{
...
bool TopViewStitching::createVBOs()
{
...
void TopViewStitching::deleteTextures()
{
...
void TopViewStitching::deleteVBOs()
{
