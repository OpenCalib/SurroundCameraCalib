...
public:
    ...
    extractor(Mat img1_bev,Mat img2_bev,int flag);
    ...
    vector<cv::Point> extrac_textures_and_save(string filename,string idx,double size);
    vector<cv::Point> extrac_textures(string idx,double size);
