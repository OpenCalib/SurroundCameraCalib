...
public:
    ...
    {
        Eigen::Matrix4d ret = Eigen::Matrix4d::Identity();
        ret << matrix(0), matrix(4), matrix(8), matrix(12), matrix(1), matrix(5), matrix(9),
    ...
    {
        auto deltaR = Eigen::Matrix3d(Eigen::AngleAxisd(deg2rad(var[2]), Eigen::Vector3d::UnitZ()) *
    ...
    static Eigen::Matrix4d R_T2RT(Mat R, Mat T)
    {
        ...
        Mat_<double> R1 =
            (cv::Mat_<double>(4, 3) << R.at<double>(0, 0), R.at<double>(0, 1), R.at<double>(0, 2),
             ...
             R.at<double>(2, 1), R.at<double>(2, 2), 0.0, 0.0, 0.0);

        cv::Mat_<double> T1 = (cv::Mat_<double>(4, 1) << T.at<double>(0, 0), T.at<double>(1, 0),
                               T.at<double>(2, 0), 1.0);
